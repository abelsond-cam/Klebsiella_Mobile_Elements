#!/usr/bin/env python3
"""Simple pipeline runner - uses mgefinder_env for everything."""
...
def main():
    parser = argparse.ArgumentParser(description="Run MGEfinder pipeline (single environment)")
    ...
    print(f">>> Using single mgefinder_env for all steps")
    ...
    if not args.pipeline_only:
        ...
        if args.test_n is not None:
            ...
            ], f"Generate LIMITED dataset ({args.test_n} samples)")
        else:
            run_command([
